void rajang(int x,boolean save){
  for(int i=0;i<x;i++){
    ...
    //ヒトタマドリ避けつつ落ちる
    tiltLeftStick(0, 0, 1000);//１秒　左上に行く予定 255の可能性あり
    ...
    for (int i=0;i<23;i++){/////////////////////////////////////
      ...
      tiltLeftStick(128, 150, 1000);//真ん中　ちょい後ろ
      tiltLeftStick(128, 170, 200);
      
    }
    /*
     *for (int i=0;i<32;i++){
     *  tiltLeftStick(128, 0, 500);//2秒上
     *  tiltLeftStick(128, 128, 1000);
     *}
